...
def update_csv_with_new_column(csv_path):
    ...
    for index, row in df.iterrows():
        ...
        if cells_status == 'cells_exists':
            ...
            text_folder_path = '/datadrive/clasification_testing_stru_unstru/CI_105/out_put/ROOT/results'
            ...
            if os.path.exists(json_file_path):
                ...
                image_name = os.path.basename(image_path)
                crop_images_path = '/datadrive/clasification_testing_stru_unstru/CI_105/crop_imgs'
...
# Example usage
csv_path = '/datadrive/clasification_testing_stru_unstru/CI_105/updated_pred.csv'
...
# croped_img_ocr_path = 'client_code/table_extraction_api/data/output/test_output1/other/ocr/MicrosoftTeams-image (3).json'
# json_file_path = '/datadrive/clasification_testing_stru_unstru/PDF_101/out_put/ROOT/results/pdf27-07.png.txt'
json_file_path = '/datadrive/clasification_testing_stru_unstru/CI_105/out_put/ROOT/results/Certificate_Of_Origin_523_page_4.png.txt'
# image_path = '/datadrive/clasification_testing_stru_unstru/PDF_101/Images/pdf27-07.png'
image_path = '/datadrive/clasification_testing_stru_unstru/CI_105/Images/Certificate_Of_Origin_523_page_4.png'
with open(json_file_path, 'r') as json_file:
    data = json.load(json_file)
